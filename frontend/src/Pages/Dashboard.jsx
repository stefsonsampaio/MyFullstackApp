...
function Dashboard() {
    ...
    const fetchData = async () => {
        try {
            const url = `http://localhost:1155/dashboard/${id}/atendimento-por-tipo`
    ...
    const fetchData2 = async () => {
        try {
            const url = `http://localhost:1155/dashboard/${id}/atendimento-funcionario`
            const token = localStorage.getItem('token')
    ...
    const fetchData3 = async () => {
        try {
            const url = `http://localhost:1155/dashboard/${id}/atendimento-por-mes`
            const token = localStorage.getItem('token')
