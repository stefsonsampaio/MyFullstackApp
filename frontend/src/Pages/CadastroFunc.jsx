...
function CadastroFunc() {
    ...
    const listaFuncionarios = async () => {
        try {
            const url = `http://localhost:1155/login/${id}/lista-funcionario`
            const token = localStorage.getItem('token')
    ...
    const demiteFuncionario = async () => {
        const url = `http://localhost:1155/login/${id}/demite-funcionario`
        try {
    ...
    const fnConfirmar = async (event) => {
        ...
        const url = `http://localhost:1155/login/${id}/cadastra-funcionario`
